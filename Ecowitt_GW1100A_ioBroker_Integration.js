...
// Function to create and update text variables (forces string type)
            ...
            try {
                ...
                data.common_list.forEach(item => {
                    ...
                    if (name === "Wind Direction") {
                        ...
                        createOrUpdateTextVariable("Wind Direction Text", directionText); // Force as text
                    } else {
